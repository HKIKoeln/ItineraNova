CodeMirror.defineMode("intextdiff", function(config, parserConfig) {
	...
	return CodeMirror.overlayParser(CodeMirror.getMode(config, parserConfig.backdrop || "text/insyntax"), intextdiffOverlay);
});

CodeMirror.defineMIME("text/intextdiff", "intextdiff");
