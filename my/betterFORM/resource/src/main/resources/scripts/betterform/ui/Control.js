        ...
        [dijit._Widget, dijit._Templated],
{
	...
	//xrxa
        if (dojo.attr(this.domNode, "xsdloc") != undefined) {
            this.appearance = dojo.attr(this.domNode, "xsdloc");
            dojo.attr(controlValueTemplate, "xsdloc", this.appearance);
        }
        if (dojo.attr(this.domNode, "services") != undefined) {
            this.appearance = dojo.attr(this.domNode, "services");
            dojo.attr(controlValueTemplate, "services", this.appearance);
        }
        if (dojo.attr(this.domNode, "nodename") != undefined) {
            this.appearance = dojo.attr(this.domNode, "nodename");
            dojo.attr(controlValueTemplate, "nodename", this.appearance);
        }
        if (dojo.attr(this.domNode, "namespace") != undefined) {
            this.appearance = dojo.attr(this.domNode, "namespace");
            dojo.attr(controlValueTemplate, "namespace", this.appearance);
        }
        if (dojo.attr(this.domNode, "nodepath") != undefined) {
            this.appearance = dojo.attr(this.domNode, "nodepath");
            dojo.attr(controlValueTemplate, "nodepath", this.appearance);
        }
        if (dojo.attr(this.domNode, "rows") != undefined) {
            this.appearance = dojo.attr(this.domNode, "rows");
            dojo.attr(controlValueTemplate, "rows", this.appearance);
        }
        //xrxa
